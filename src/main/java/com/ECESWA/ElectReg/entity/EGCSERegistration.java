...
@Entity
@Table(name = "EGCSERegistration")
public class EGCSERegistration {
    ...
    @Column(name="year")
    private int year;
    @Column(name="ovcstatus", nullable = false, unique = true)
    private String ovcStatus;

    public EGCSERegistration() {
    }

     public EGCSERegistration(int centre, String surname, String names, String gender, Date dateOfBirth, String nationalId, String foreignId, List<String> subjects, int certificateLevel, int year, String ovcStatus) {
        this.centre = centre;
